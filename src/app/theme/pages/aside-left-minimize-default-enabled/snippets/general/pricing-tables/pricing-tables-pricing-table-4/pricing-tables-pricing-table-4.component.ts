...
@Component({
    selector: "app-pricing-tables-pricing-table-4",
    templateUrl: "./pricing-tables-pricing-table-4.component.html",
    encapsulation: ViewEncapsulation.None,
})
export class PricingTablesPricingTable4Component implements OnInit, AfterViewInit {
