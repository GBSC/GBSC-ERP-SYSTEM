...
@Component({
    selector: 'app-taxonbenefits',
    templateUrl: './taxonbenefits.component.html',
    styleUrls: ['./taxonbenefits.component.scss']
})
export class TaxonbenefitsComponent implements OnInit {
